            ...
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    ...
                    <a href="#">
                        <b class="logo-icon" >
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url(); ?>adminmart/assets/images/LOGO.jpeg" alt="homepage" class="dark-logo" width="200"/>
                           
                            <!-- Light Logo icon 
                            <img src="https://www.ddecochabamba.gob.bo/wp-content/uploads/2019/09/logo2.png" alt="homepage" class="light-logo" />-->
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text 
                        <span class="logo-text">-->
                            <!-- dark Logo text 
                            <img src="<?php echo base_url(); ?>adminmart/assets/images/logo-text.png" alt="homepage" class="dark-logo" />-->
                            <!-- Light Logo text 
                            <img src="<?php echo base_url(); ?>adminmart/assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
                        </span>-->
                    </a>
                </div>
                <!-- ============================================================== -->
