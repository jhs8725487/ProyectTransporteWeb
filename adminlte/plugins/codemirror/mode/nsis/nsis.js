...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("<?php echo base_url(); ?>adminltelib/codemirror"), require("<?php echo base_url(); ?>adminlteaddon/mode/simple"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["<?php echo base_url(); ?>adminltelib/codemirror", "<?php echo base_url(); ?>adminlteaddon/mode/simple"], mod);
